...
void Vm_mux21___024root__trace_chg_0_sub_0(Vm_mux21___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vm_mux21___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vm_mux21___024root__trace_chg_0\n"); );
    // Init
    ...
    // Body
    Vm_mux21___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vm_mux21___024root__trace_chg_0_sub_0(Vm_mux21___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    (void)vlSelf;  // Prevent unused variable warning
    Vm_mux21__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vm_mux21___024root__trace_chg_0_sub_0\n"); );
    // Init
    ...
    bufp->chgBit(oldp+4,(((~ (IData)(vlSelf->s)) & (IData)(vlSelf->a))));
    bufp->chgBit(oldp+5,(((IData)(vlSelf->b) & (IData)(vlSelf->s))));
    bufp->chgBit(oldp+6,((1U & (~ (IData)(vlSelf->s)))));
}
