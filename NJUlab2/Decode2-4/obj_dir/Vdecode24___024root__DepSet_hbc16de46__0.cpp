...
extern const VlUnpacked<CData/*3:0*/, 8> Vdecode24__ConstPool__TABLE_h0564a3fb_0;
...
VL_INLINE_OPT void Vdecode24___024root___ico_sequent__TOP__0(Vdecode24___024root* vlSelf) {
    ...
    vlSelf->y = Vdecode24__ConstPool__TABLE_h0564a3fb_0
        [__Vtableidx1];
}
...
#endif
            VL_FATAL_MT("decode24.v", 1, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("decode24.v", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("decode24.v", 1, "", "Active region did not converge.");
            }
